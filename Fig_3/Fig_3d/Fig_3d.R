...
##==== Prepare data ====##
kendallRaster <- raster('CV_Total_Interpret_Ex.tif')
...
# Draw
Fig_3d <- ggplot(data = resultMatrix,mapping = aes(x = Alt,y = Lat))+
...
pdf(file = 'Fig_3d.pdf',width = 1.5,height = 2.64)
print(Fig_3d)
dev.off()
##==== Draw ====##