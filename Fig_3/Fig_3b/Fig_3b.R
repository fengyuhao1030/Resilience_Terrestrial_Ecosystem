...
##==== Prepare data ====##
kendallRaster <- raster('Mean_Total_Interpret_Ex.tif')
...
# Draw
Fig_3b <- ggplot(data = resultMatrix,mapping = aes(x = Alt,y = Lat))+
...
pdf(file = 'Fig_3b.pdf',width = 1.5,height = 2.64)
print(Fig_3b)
dev.off()
##==== Draw ====##