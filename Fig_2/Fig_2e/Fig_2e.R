...
##==== Part 1: Prepare data ====##
kendallRaster <- raster('Proportion_TEM_Interpretation.tif')
...
Fig_2e <- ggplot(data = drawMatrix,mapping = aes(x = Class,y = Value))+
...
pdf(file = 'Fig_2e.pdf',width = 4.89,height = 2.3)
print(Fig_2e)
dev.off()
##==== Part 4: Draw ====##